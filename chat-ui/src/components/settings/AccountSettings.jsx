...
export default function AccountSettings() {
  ...
  return <><Box sx={{ p: 1.5, borderTop: "1px solid #2a2f3a" }}>
    ...
    <DialogContent><Typography variant="h6">Groq API key</Typography><Typography sx={{ color: "#cbd5e1", fontSize: ".8rem", mt: 1 }}>Configured securely. The key value is never displayed or returned to this extension.</Typography>
