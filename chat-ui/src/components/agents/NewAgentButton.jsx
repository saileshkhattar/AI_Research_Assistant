...
export default function NewAgentButton() {
  ...
  const handleCreate = async () => {
    ...
    try {
      await AgentAPI.createAgent({ user_id: userId, name: agentName });
      handleClose();
    } catch (err) {
      setError("Failed to create agent. Please try again.", err.message);
    } finally {
      setLoading(false);
    }
  };
          ...
          <Box sx={{ px: 3, pt: 2.5, pb: 3 }}>
            ...
            <Box sx={{ display: "flex", gap: 1.5, mt: 3 }}>
              ...
              <Button
                ...
                startIcon={
                  loading ? (
                    <CircularProgress size={14} sx={{ color: "#0e0e11" }} />
                  ) : (
